...
Of the six activation functions used in this study, the Exponential function gives the best results in terms of solution quality, while the ReLU function gives the worst as reported by $\Delta E=\sqrt{\RMSE^2+\MARE^2}$.
